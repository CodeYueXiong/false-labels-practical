...
The code is ported from https://github.com/Cartucho/mAP
If you want to set mAP as 0.x, such as calculating mAP 0.75, you can set MINOVERLAP = 0.75.
'''
MINOVERLAP = 0.5
...
# parser.add_argument("-f", "--file", required=False)  # required with colab
    ...
    for class_index, class_name in enumerate(gt_classes):
        ...
        for idx, detection in enumerate(dr_data):
            ...
            if show_animation:
                ...
                # show image
                # cv2.imshow("Animation", img)  # cannot show with colab
                # cv2.waitFKey(20) # show for 20 ms
